    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div className=" mx-6 md:mx-18 flex items-center justify-center flex-col text-center">
                ...
                <p className="text-black/50 md:text-[16px] md:py-4 py-2">Account Number: <span className="text-black font-bold">{accountNumber}</span></p>
                <p className="text-black/50 md:text-[16px] ">You can now access your account using the default login credentials sent to your registered email address.</p>
            </div>
            <div className="my-5 md:w-1/2 border-b border-gray-300 pb-6 md:pb-8">
                <a href={url} target="_blank">
                <PrimaryButton>Login to Internet Banking</PrimaryButton>
                </a>
            </div>
