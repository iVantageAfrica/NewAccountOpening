...
export const currentAccountSchema = z.object({
  ...
  lga: z.string().min(1, "Local Government is required").max(50, "Local Government is too long"),
  origin: z.string().min(1, "State of origin is required").max(50, "State of origin is too long"),
