...
export const currentAccountSchema = z.object({
  ...
  state: z.string().min(1, "State is required").max(150, "State is too long"),
  lga: z.string().min(1, "Local Government is required").max(100, "Local Government is too long"),
  origin: z.string().min(1, "State of origin is required").max(100, "State of origin is too long"),
